...
export const projectsData = [
  ...
  },
  {
    ...
    technologies: ["Express", "Node.js", "MongoDB", "Backend Development"],
    category: "Console",
  ...
  },
  {
    ...
    technologies: ["Node.js", "Express", "Backend Development"],
    category: "Console",
  ...
  },
  {
    ...
    description:
      "A comprehensive RESTful API backend for a service marketplace platform with real-time features, payment processing, authentication, and admin management.",
    image:
      "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1634&q=80",
    technologies: ["Node.js", "Express", "TypeScript", "PostgreSQL", "Prisma", "Redis", "Socket.io", "JWT", "Stripe", "Backend Development"],
    category: "Console",
    codeLink: "https://github.com/Xoli-Nxiweni/spana-backend"
  },
  {
    id: 14,
    title: "EKASI Tours - Tour Guide Website",
    description:
      "A full-stack bicycle tour booking system with customer-facing website, admin CMS panel, and RESTful API backend. Features include tour browsing, booking management, user authentication, contact forms, and comprehensive admin dashboard with statistics.",
    image:
      ekasiToursHero,
    technologies: ["React", "Vite", "Node.js", "Express", "MongoDB", "Supabase", "Tailwind CSS", "shadcn/ui", "JWT", "TypeScript", "React Router"],
    category: "Web",
    codeLink: "https://github.com/Xoli-Nxiweni/EkasiTours-Wandi"
  },
  {
    id: 15,
    title: "SPANA Services Marketplace Website",
    description:
      "Public-facing marketing website for SPANA services marketplace. Features service browsing, provider directory, service details, careers/application portal, and contact forms. Built with React 19 and Vite, consuming the SPANA backend API via REST endpoints.",
    image: spanaWebsiteHero,
    technologies: ["React", "Vite", "React Router", "CSS3", "REST API", "Lucide React"],
    category: "Web",
